      ...
      <div className="modal-dialog">
        ...
        >
          ...
          <div className="modal-header" style={{ fontWeight: "bold" }}>
            <h2 style={{ color: "white", textAlign: "center", display:"block" }}>
              Open a new <span style={{ color: "rgb(0, 0, 254)" }}>B</span>ad
              <span style={{ color: "rgb(254, 0, 0)" }}>B</span>ank account
              and recieve $500 dollars
            </h2>
            <button type="button" class="btn btn-secondary close text-white fs-2" data-bs-dismiss="modal" style={{ border:"solid 1px white"}}>&times;</button>
          </div>
          <div
            className="modal-body bg-dark"
            style={{ color: "white", fontSize: "1rem" }}
          >
            <h5 style={{color: "rgb(255, 154, 1)", textAlign: "center", }}>
              Styling: Material Design Bootstrap, Sass, Font Awesome, CSS,
              LottiFiles.
            </h5>
            <br />
            <p style={{ color: "rgb(255, 154, 4)", fontSize:"1.3rem" }}>
              New and Extra Features:
            </p>
            <ul>
              <li>Promotional Popup</li>
              <li>Footer</li>
              <li>Login/Logout options</li>
              <li>Registration Form Validation with REGEX.</li>
              <li>Extra Password Confirmation</li>
              <li>Account Dashboard </li>
              <li>Monitor User and Account Activities</li>
            </ul>
            <p style={{ color: "rgb(255, 154, 4)" , fontSize:"1.3rem" }}>How to use this app?</p>
            <p>
              Start by hitting the Home Button and hover and click on the
              navigation buttons and the register button.
            </p>
            <ol>
              <li>
                Register a new BadBank account.
                <br />
                Form validation will guide you through the process.
                <br />
                Try inputing the wrong information to see validation.
              </li>
              <br />
              <li>Login to your account or register a new bank account.</li>
              <br />
              <li>
                when you login : you will land on the dashboard where you get
                a summary of your account, last 4 digits of your account
                number, summary of latest transactions and account balance.
                <br /> Choose type of transaction.
              </li>
              <br />
              <li>
                Whether you choose deposit or withdraw, the form will guide
                you through transaction validations.
              </li>
              <br />
              <li>
                Check the dashboard to see a history of your transactions.
              </li>
              <br />
              <li>Visit User Data to check your account information.</li>
              <br />
              <li>logout and login with your account email and password.</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div className="row py-5">
          ...
          <div className="column-66">
            <h4>
              ...
              <hr />
              Earn 5X Membership Rewards® Points on all purchases made with our
              revolutionary services through the BadBank App.
            </h4>
          </div>
